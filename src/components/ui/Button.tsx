...
export default function Button({
  ...
  const baseStyles =
    "inline-flex items-center text-sm justify-center h-10 gap-2 font-medium rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
