...
export default function PatientAppointments() {
    ...
    const loadAppointments = async () => {
        try {
            ...
            setError(error.message || 'Không thể tải danh sách lịch hẹn. Vui lòng thử lại.');
            setAppointments([]);
        } finally {
            setLoading(false);
        }
            ...
            >
                ...
                {selectedAppointment && (
                    <div style={{ marginTop: '1rem', padding: '1rem', background: '#f3f4f6', borderRadius: '0.5rem' }}>
                        ...
                        {typeof selectedAppointment.doctorId === 'object' && selectedAppointment.doctorId && (
                            <div>
                                <strong>Bác sĩ:</strong> {selectedAppointment.doctorId.fullName}
                            </div>
                        )}
                    </div>
                )}
