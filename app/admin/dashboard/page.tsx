                ...
                <Card className={styles.statCard}>
                    <CardBody>
                        <div className={styles.statContent}>
                            ...
                            <div>
                                <div className={styles.statValue}>{formatCurrency(stats.unpaidAmount)}</div>
                    ...
                    <CardBody>
                        <div className={styles.revenueGrid}>
                            <div className={styles.revenueItem}>
                                <div className={styles.revenueLabel}>Tổng doanh thu</div>
                                <div className={styles.revenueValue}>{formatCurrency(stats.totalRevenue)}</div>
                            </div>
                            <div className={styles.revenueItem}>
                                <div className={styles.revenueLabel}>Đã thanh toán</div>
                                <div className={styles.revenueValue} style={{ color: '#10b981' }}>
                                    {formatCurrency(stats.paidAmount)}
                                </div>
                            </div>
                            <div className={styles.revenueItem}>
                                <div className={styles.revenueLabel}>Chưa thanh toán</div>
                                <div className={styles.revenueValue} style={{ color: '#ef4444' }}>
